...
class CumulativeStatisticsLayerTest(test_utils.TestCase,
  ...
  def _GetExpectedTestOutputs(self):
    ...
    expected_outputs['MEAN'] = {
        False:
            np.array([[22.066668, 23.066668, 24.066668], [24.5, 25.5, 26.5]]),
        True:
            np.array([[25.424778, 26.424774, 27.424776],
                      [26.75111, 27.751108, 28.75111]])
    }
    expected_outputs['MEAN_STD'] = {
        ...
        True:
            ...
            ], [26.75111, 27.751108, 28.75111, 12.927436, 12.927438,
                12.927436]])
    }
